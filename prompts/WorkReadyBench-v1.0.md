# WorkReadyBench v1.0 — Model Prompts

Send each numbered prompt in a separate, fresh chat. Copy it exactly. Do not send the title above it or any scoring material.
...
## P4 — Evidence-disciplined incident update
...
Return JSON only, with no code fence or explanation.
```

## P7 — Apply a written policy
...
## P8 — Prioritize under pressure

```text
It is 9:00 a.m. Rank these tasks and give me a practical plan through noon. Then write the first message I should send. Keep the whole answer under 180 words.
